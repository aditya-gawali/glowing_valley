    ...
    return (
        <>
            <div className="w-full bg-gray-100" >
                <h1 className="text-4xl font-serif  text-[#041e42] px-10 lg:px-20 py-10">{props.category}</h1>

                <div className="flex flex-row px-10 divide-y divide-x md:px-20 pb-10 flex-wrap">
